/*
  ...
  - Added the required column `date` to the `daily_task_employees` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `daily_task_employees` ADD COLUMN `date` DATETIME NOT NULL;
