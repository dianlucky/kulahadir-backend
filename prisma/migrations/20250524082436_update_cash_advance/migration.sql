/*
  ...
  - Added the required column `created_at` to the `cash_advances` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `cash_advances` ADD COLUMN `created_at` TIMESTAMP NOT NULL;
