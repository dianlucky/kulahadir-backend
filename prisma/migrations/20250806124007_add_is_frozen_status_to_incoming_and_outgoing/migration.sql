...
-- AlterTable
ALTER TABLE `incoming_items` ADD COLUMN `isFrozen` BOOLEAN NOT NULL DEFAULT false,
    MODIFY `created_at` TIMESTAMP NOT NULL;
...
-- AlterTable
ALTER TABLE `outgoing_items` ADD COLUMN `isFrozen` BOOLEAN NOT NULL DEFAULT false,
    MODIFY `created_at` TIMESTAMP NOT NULL;
