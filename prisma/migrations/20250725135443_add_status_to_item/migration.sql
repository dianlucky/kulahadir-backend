/*
  ...
  - You are about to alter the column `created_at` on the `incoming_details` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
  - You are about to alter the column `created_at` on the `incoming_items` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
  ...
  - You are about to alter the column `created_at` on the `outgoing_details` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
  - You are about to alter the column `created_at` on the `outgoing_items` table. The data in that column could be lost. The data in that column will be cast from `Timestamp(0)` to `Timestamp`.
...
-- AlterTable
ALTER TABLE `incoming_details` MODIFY `created_at` TIMESTAMP NOT NULL;

-- AlterTable
ALTER TABLE `incoming_items` MODIFY `created_at` TIMESTAMP NOT NULL;

-- AlterTable
ALTER TABLE `items` ADD COLUMN `status` VARCHAR(50) NOT NULL DEFAULT 'aktif';
...
-- AlterTable
ALTER TABLE `outgoing_details` MODIFY `created_at` TIMESTAMP NOT NULL;

-- AlterTable
ALTER TABLE `outgoing_items` MODIFY `created_at` TIMESTAMP NOT NULL;
